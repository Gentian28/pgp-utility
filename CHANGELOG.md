...
- **Revocation certificates** are produced when a key is created and can be saved alongside it.
  Publishing one retires a key you have lost access to. It cannot be created later, because
  creating one needs the private key and the passphrase you would have lost.
