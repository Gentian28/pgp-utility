...
param(
    ...
    [string]$Repo = 'Gentian28/pgp-utility'
)

$ErrorActionPreference = 'Stop'
$root = $PSScriptRoot
$asset = 'PgpUtility-win-Setup.exe'
...
# The release workflow names the checksum file after the Velopack channel, which is "win" here.
$sumsUrl = "https://github.com/$Repo/releases/download/v$Version/SHA256SUMS-win.txt"
...
if (-not $line) { throw "No $asset entry in SHA256SUMS-win.txt for v$Version." }
...
Next:
  ...
  3. Copy these files to manifests/g/Gentian28/PgpUtility/$Version/
  4. Open a PR titled: New version: Gentian28.PgpUtility version $Version
"@
